function newgroundsPlugin(k) {
	const newgrounds = {
		...
		ngGetScores(
			...
			const board = k.scoreboards.find(b => b.id == id);
			const scores = ngCall("ScoreBoard.getScores", {
				id: board.id,
				user,
				period,
				social,
	...
	!function(t, e) {
		...
		var t = t || function(t, e) {
			...
			if (
				...
				&& (r = window.crypto),
					!r && "undefined" != typeof window && window.msCrypto
					&& (r = window.msCrypto),
					!r && "undefined" != typeof global && global.crypto
					&& (r = global.crypto),
			...
			c.BufferedBlockAlgorithm = s.extend({
				...
				_process: function(e) {
					var r,
						...
						f = (s = e
							? t.ceil(s)
							: t.max((0 | s) - this._minBufferSize, 0)) * c,
						u = t.min(4 * f, o);
					if (f) {
						for (var h = 0; h < f; h += c) {
				...
				var r = t,
					...
					_ = (r.format = {}).OpenSSL = {
						stringify: function(t) {
							...
							return (r
								? o.create([1398893684, 1701076831]).concat(r)
									.concat(e)
								: e).toString(a);
						},
						parse: function(t) {
							var e, r = a.parse(t), i = r.words;
							return 1398893684 == i[0] && 1701076831 == i[1]
				...
				var l = [0, 1, 2, 4, 8, 16, 32, 64, 128, 27, 54],
					y = i.AES = r.extend({
						...
						_doCryptBlock: function(t, e, r, i, n, o, c, s) {
							...
							y = (s[f >>> 24] << 24 | s[u >>> 16 & 255] << 16
								| s[h >>> 8 & 255] << 8 | s[255 & d]) ^ r[p++],
								_ = (s[u >>> 24] << 24 | s[h >>> 16 & 255] << 16
									| s[d >>> 8 & 255] << 8 | s[255 & f])
									^ r[p++],
								v = (s[h >>> 24] << 24 | s[d >>> 16 & 255] << 16
									| s[f >>> 8 & 255] << 8 | s[255 & u])
									^ r[p++],
								g = (s[d >>> 24] << 24 | s[f >>> 16 & 255] << 16
									| s[u >>> 8 & 255] << 8 | s[255 & h])
									^ r[p++];
							t[e] = y, t[e + 1] = _, t[e + 2] = v, t[e + 3] = g;
						},
						keySize: 8,
					});
